...
Our function then grabs the layout and manipulates some state that is
needed in the global look and feel. This, of course, could have been
done in our ``AppLayout`` class, but in some cases, different views
...
Here we break our global layout into reusable parts via *panels*. Where
do these come from? ``@panel_config`` decorators, as shown in
...
This shows that a panel can be parameterized and used in different
